...
public class PagamentoDAO {
    ...
    String sql = "INSERT INTO pagamentos (idCliente, numeroCartao, nomeCartao, validade, cvv, valorTotal, dataPagamento, idVenda) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    try (Connection con = getConnection();
        ...
        pstm.setInt(8, pagamento.getIdVenda()); // <-- aqui está o vínculo da venda
